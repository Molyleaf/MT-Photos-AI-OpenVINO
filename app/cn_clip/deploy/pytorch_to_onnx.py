...
# --- 修正 1: 导入 onnxconverter_common ---
# from onnxmltools.utils import convert_float_to_float16 # 已废弃
...
if __name__ == '__main__':
    ...
    # 修正：检查 args.pytorch_ckpt_path 是否为 None，以避免在 Python 3.12+ 中引发 TypeError
    if args.pytorch_ckpt_path and os.path.isfile(args.pytorch_ckpt_path):
        input_ckpt_path = args.pytorch_ckpt_path
    elif args.model_arch in _MODELS:
        # 修正：_download(args.model_arch, ...) 传递字符串Key
        input_ckpt_path = _download(args.model_arch, args.download_root or os.path.expanduser("./cache/clip"))
    else:
